...
AcceptNesNotification _$AcceptNesNotificationFromJson(
  ...
  $checkKeys(json, requiredKeys: const ['sessionId', 'id']);
  final val = AcceptNesNotification(
    sessionId: $checkedConvert(
      'sessionId',
      (v) => _decodeAcceptNesNotificationSessionId(v),
    ),
    id: $checkedConvert('id', (v) => _decodeAcceptNesNotificationId(v)),
...
Map<String, dynamic> _$AcceptNesNotificationToJson(
  ...
  'id': ?_encodeAcceptNesNotificationId(instance.id),
...
NesJumpSuggestion _$NesJumpSuggestionFromJson(Map<String, dynamic> json) =>
    $checkedCreate('NesJumpSuggestion', json, ($checkedConvert) {
      $checkKeys(json, requiredKeys: const ['id', 'uri', 'position']);
      final val = NesJumpSuggestion(
        id: $checkedConvert('id', (v) => _decodeNesJumpSuggestionId(v)),
...
Map<String, dynamic> _$NesJumpSuggestionToJson(NesJumpSuggestion instance) =>
    <String, dynamic>{
      'id': ?_encodeNesJumpSuggestionId(instance.id),
...
NesRenameSuggestion _$NesRenameSuggestionFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('NesRenameSuggestion', json, ($checkedConvert) {
  $checkKeys(json, requiredKeys: const ['id', 'uri', 'position', 'newName']);
  final val = NesRenameSuggestion(
    id: $checkedConvert('id', (v) => _decodeNesRenameSuggestionId(v)),
...
Map<String, dynamic> _$NesRenameSuggestionToJson(
  ...
  'id': ?_encodeNesRenameSuggestionId(instance.id),
...
PlanCapabilities _$PlanCapabilitiesFromJson(Map<String, dynamic> json) =>
    $checkedCreate('PlanCapabilities', json, ($checkedConvert) {
      final val = PlanCapabilities(
        meta: $checkedConvert(
          '_meta',
          (v) => const AcpMetaConverter().fromJson(v),
        ),
